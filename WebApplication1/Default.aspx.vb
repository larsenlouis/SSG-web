...
Public Class _Default
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim QRimg(255) As Drawing.Bitmap
        ...
        Try
            ...
            For index = 0 To urlcount
                ...
                If hwresponse.StatusCode = Net.HttpStatusCode.OK Then
                    Dim bitmap As New Drawing.Bitmap(hwresponse.GetResponseStream)
        ...
        'If File.Exists("config.json") Then File.Delete("config.json")
        'Dim jsonwriter As New StreamWriter("config.json", False, UTF8WithoutBom)
        Dim ServerHistory As String = vbNullString
        Dim servercount As Integer = -1
        Dim configjson As String = vbNullString
        'a new record
        configjson += "["
        'parse param
        For index = 0 To urlcount
            ...
            configjson += """name"":""" + Countries(index) + "-" + server + ":" + server_port + ""","
            configjson += """origin"":""local"","
        ...
        'serve the config.json file to web user
        Response.Clear()
